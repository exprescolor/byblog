...
layout:     post
title:      快速搭建个人博客
subtitle:   （转载）手把手教你在半小时内搭建自己的个人博客
date:       2025-03-05
author:     BY
...
# 转载说明
作者使用BY的教程与开源资源，高效且顺利地完成了基于github的个人网站搭建，感谢BY，若有想搭建属于自己个人博客的读者，可以从该篇教程中获取详尽的帮助，开源资源可以从BY的 [github仓库](https://github.com/qiubaiying/qiubaiying.github.io) 中获取，若获得帮助，可以**star**表示反馈与激励！
以下是转载内容：
